...
<!--end of nav---mc_-->
  ...
  <div class="form-row ">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="phone" class="form-control" id="inputPassword4" placeholder="Phone..">
    </div>
  </div>
  <div class="form-group">
    <label for="inputAddress">Address</label>
    <input type="text" name="addr1" class="form-control" id="inputAddress" placeholder="lacality/ Main Streat...">
  </div>
  <div class="form-group">
    <label for="inputAddress2">Address 2</label>
    <input type="text" name="addr2" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor/bulging name..">
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
  ...
  <input  type="submit" name="sub" class="btn btn-primary bg-success text-white" value="Sign in">
</form>
      </div>
   	</div>
...
if (isset($_POST['sub']))
 {
  ...
  $name=$_POST['name'];
      $phone=$_POST['phone'];
        ...
        $sql="INSERT INTO `user_de`( `name`, `phone`, `addr1`, `addr2`, `city`, `state`, `zip`) VALUES ('$name','$phone','$addr1','$addr2','$city','$state','$pin')";

      if (mysqli_query($conn,$sql)==1)
       {
         $order=mysql_insert_id($conn);
         $sql="INSERT INTO `user_order`(`id`, `itename`, `price`, `qunt`, `imgpath`) VALUES (?,?,?,?,?)";
           $stmt=mysqli_prepare($conn,$sql);
           if ($stmt)
            {
           mysqli_stmt_bind_param($stmt,"isii",$order,$order_name,$order_price,$order_quantity,$path);
            	...
            	echo "<script>alert('order placed...' );window.open('index.php','_self')</script>";
           }
           else
           {
        ...
        //echo "<script>alert('Ordered Sucessfully..');window.open('cart.php','_self')</script>";
      }
